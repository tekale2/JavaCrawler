...
\section{Conclusion}
In this project we have proposed a novel method for informational retrieval and display of documents from the US Federal Register website. The whole process is divided into three phases. In the first phase we crawl the documents from the website and save it in the appropriate format which would be beneficial  during the indexing phase. Once the crawling phase is done, we launch solr with fine tuned settings to index the crawled documents efficiently. In the final phase we develop the user interface. It is of utmost importance for the users to identify the type of document as well as the publishing agency, when they search for the that document. Hence we have proposed an interactive graph structure to quickly represent a document and where it lies in the federal bureaucracy.  If time permits, we look forward to further improve our user interface by adding more features suck as document quick peek and graph overview, which would further improve the user interface.
